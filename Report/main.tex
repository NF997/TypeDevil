...
The following section will give deeper insights into this approach.
...
Another characteristic of state of the art static type checkers is their mature type inference, which means that developers do not have to provide special type annotations at any point in their program per se.
...
They all compile the annotated code back to plain JavaScript which runs in all common JavaScript engines and does not have any runtime type checks.


\subsection{Introduction to TypeScript}
To provide to necessary background for the upcoming comparison in \ref{comparison}, I would like to introduce TypeScript.
