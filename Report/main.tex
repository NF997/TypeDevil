...
\title{Seminar Report\\-\\TypeDevil: Dynamic Type Inconsistency Analysis for JavaScript}

% a short form should be given in case it is too long for the running head
\titlerunning{Seminar Report - TypeDevil}
...
% \begin{abstract}
% The abstract2 should summarize the contents of the paper and should
...
and typeset in 9-point type (Fig. shows an example).
...
\section{Static Type Checkers as an Alternative to Dynamic Analysis}

\subsection{General Approach of Static Type Checkers}
